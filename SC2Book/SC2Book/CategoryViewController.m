...
- (void)viewDidLoad
{
    ...
    [self.nav.view setFrame:CGRectMake(10, 10, 200, 300)];
    self.CategoryTableView = [[UITableView alloc]initWithFrame:CGRectMake(10, 10, 300, 300) style:UITableViewStylePlain];
